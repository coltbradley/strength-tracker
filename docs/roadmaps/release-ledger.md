...
| A-135 | Production verify/rollback | Engineering | fixed with test | scripts/check-deploy-contract.test.mjs served-SHA assertions; docs/deploy.md Rollback | Run 36046324530 receipt: served_sha=bc203a0… equals sha (2026-09-24) | Remove the build.json poll from the smoke step |
